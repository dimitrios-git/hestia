" GENERATED by themes/hestia/render.py from palette.yml v0.8.1 + scopes.yml — do not edit; edit the sources and re-render
...
if &background ==# 'dark'
  ...
  hi Todo guifg=#af87ff guibg=#1a1a1a gui=reverse cterm=reverse
  ...
  hi Special guifg=#af87ff guibg=NONE gui=NONE cterm=NONE
