" GENERATED by themes/hestia/render.py from palette.yml v0.12.0 + scopes.yml — do not edit; edit the sources and re-render
...
if &background ==# 'dark'
  ...
  hi Visual guifg=#7c3aed guibg=#ffffff gui=reverse cterm=reverse
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Visual ctermfg=99 ctermbg=231 cterm=reverse
